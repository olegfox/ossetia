...
class Page
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="Menu", mappedBy="page", cascade={"persist", "remove"})
     **/
    private $menu;
     ...
     * Add menu
     *
     * @param \Site\MainBundle\Entity\Menu $menu
     * @return Page
     */
    public function addMenu(\Site\MainBundle\Entity\Menu $menu)
    {
        $this->menu[] = $menu;
     ...
     * @param \Site\MainBundle\Entity\Menu $menu
     */
    public function removeMenu(\Site\MainBundle\Entity\Menu $menu)
    {
